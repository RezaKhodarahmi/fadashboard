...
import { newCategory, fetchData } from 'src/store/apps/category'
...
export default function NewCategoryForm() {
  ...
  return (
    <>
      <Card>
        <CardHeader title='Add New Course Category' />
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container spacing={2}>
              ...
              {/* Meta Title */}
              <Grid marginTop={5} item xs={12} sm={12}>
                <TextField {...register('metaTitle')} name='metaTitle' label='Category Meta Title' fullWidth />
                {errors.metaTitle && (
